...
@CucumberOptions(
        monochrome = true,
        features = {"classpath:feature/cart/add_cellphone_to_cart_expression.feature"},
        glue = "com.adam.test.defs.expression",
        plugin = "html:target/report/cucumber_expression.html"
)
