...
@CucumberOptions(
        monochrome = true,
        features = {"classpath:feature/cart/add_cellphone_to_cart_selftype.feature"},
        glue = {"com.adam.test.defs.selftype", "com.adam.test.types"},
        plugin = "html:target/report/cucumber_selftype.html"
)
